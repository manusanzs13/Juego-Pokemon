...
function gameOver() {
    ...
    song.pause();
    setTimeout(function() {
        while(rejilla.firstChild) {                     // Cuando hagamos reinicio entonces se borra la primera
            rejilla.removeChild(rejilla.firstChild);    // rejilla para quedarnos con una nueva y seguir jugnando
        }
    },1000);
}
